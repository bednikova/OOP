...
Wallet::Wallet(char* name, double money)
{
    strcpy(owner,name);
    fiatMoney = money;
    id = returnId();
...
/*
//shte proverqva dali za tova idd sa dostatychno parite koito ima
//ili fmiCoins koito pritejava
bool searchWalletIdOrder(unsigned idd, const Order& o)
{
